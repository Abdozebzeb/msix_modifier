# What i want
now i want the app to be useable as is by selecting the files or folders using the gui, and i want to be able to use command line for it, be it absolute paths or relitive paths
- Flags
    - --config will be used to point to a custom config.md or any xyz.md which will be in the config.md expected format
    - --msixin will be the selected msix to edit
    - --misxout will be a folder where the edited misx is supposed to be output
    - --fileextension {extension} {display_name} will be used to pass file extensions if the person entirly wants to skip the use of config

- Example Command lines
- msix_modifier.exe --config="./hehe.md" --msixin="./Releases/V1" --msixout="./Releases/V1/Msix_With_File_extension"
    This example uses reltive paths and paths are inside "" as a string, note if the msixout folder doesnot exist the app is supposed to create it
- msix_modifier.exe --config=./hehe.md --msixin=./Releases/V1 --msixout=./Releases/V1/Msix_With_File_extension
    This example does not enclose paths in ""
- msix_modifier.exe --config=C:Users/Me/Projects/hehe.md --msixin=C:Users/Me/Projects/Releases/V1 --msixout=C:Users/Me/Projects/Releases/V1/Msix_With_File_extension
- msix_modifier.exe --config="C:Users/Me/Projects/hehe.md" --msixin="C:Users/Me/Projects/Releases/V1" --msixout="C:Users/Me/Projects/Releases/V1/Msix_With_File_extension"
- msix_modifier.exe --msixin="./Releases/V1" --msixout="./Releases/V1/Msix_With_File_extension" --fileextension .sample "A Sample File Extension"
    This example passes extensions directly in the command
- msix_modifier.exe --msixin="./Releases/V1" --msixout="./Releases/V1/Msix_With_File_extension" --fileextension .sample "A Sample File Extension" --fileextension .ppmsolved "Solved Past Paper File"
    This example passes 2 extionsions in one command, there can be inifinate number of exteionsions passed, but only 1 of each msixin msixout config
